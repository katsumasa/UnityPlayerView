namespace UTJ.UnityPlayerView
{
    ...
    public class UnityPlayerViewPlayer : MonoBehaviour
    {
        ...
        {
            //Debug.Log("OnEnable");
            PlayerConnection.instance.Register(UnityPlayerView.kMsgSendEditorToPlayer, OnMessageEvent);
        }
        ...
        {
            //Debug.Log("OnDisable");
            PlayerConnection.instance.Unregister(UnityPlayerView.kMsgSendEditorToPlayer, OnMessageEvent);
        }
        ...
        private void OnMessageEvent(MessageEventArgs args)
        {
            ...
            editorSendData = JsonUtility.FromJson<UnityPlayerView.EditorSendData>(json);
            switch (editorSendData.command)
            {
                case UnityPlayerView.Command.Play:
                    {
                ...
                case UnityPlayerView.Command.Pause:
                    {
                        isPause = !isPause;
                    }
                    break;

                case UnityPlayerView.Command.Stop:
                    {
                        isPlay = false;
                    }
                    break;
                    ...
                    default:
                    #endif
                        {
                            ...
                            PlayerConnection.instance.Send(
                                UnityPlayerView.kMsgSendPlayerToEditor,
